...
import OrderLogo from '../assets/order-complete.png';
...
export default function OrderThank() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.subtitle}>Ваш заказ успешно размещен</Text>

      <View style={styles.qrContainer}>
        <QRCode value={'https://www.savvarest.ru/'} size={width / 2} />
      </View>
